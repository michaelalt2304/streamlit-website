...
if all_user_files and models:
    ...
    name_labels = kv_select([['Names', 'Confidence Scores'], [True, False]], 'What would you like to see as the annotations?')
    ...
    if val:
        with st.spinner('Annotating...'):
            if f_type == 'Image':
                ...
                id_ann_vid = ann_video(cur_file, cur_model, threshold = threshold, name_labels = name_labels, notes=notes)
